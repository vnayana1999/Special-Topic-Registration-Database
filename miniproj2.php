...
if (!empty($mp_name2) ||!empty($username21) || !empty($usn21) ||!empty($sem21) || !empty($email21)|| !empty($phone21)||!empty($username22) || !empty($usn22) ||!empty($sem22) || !empty($email22)|| !empty($phone22)) {
 $host = "localhost";
    $dbUsername = "root";
    $dbPassword = "";
    $dbname = "student_1";
    ...
    if (mysqli_connect_error()) {
     ...
     $INSERT = "INSERT Into miniproj2 (mp_name2,username21, usn21,sem21,email21, phone21,username22, usn22,sem22,email22, phone22) values(?,?, ?, ?, ?, ?, ?, ?,?,?,?)";
     //Prepare statement
     ...
     if ($rnum==0) {
      ...
      $stmt->bind_param("sssisissisi",$mp_name2, $username21, $usn21, $sem21,$email21, $phone21,$username22, $usn22, $sem22,$email22, $phone22);
      $stmt->execute();
